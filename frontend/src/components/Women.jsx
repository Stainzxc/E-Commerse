...
export default function Men() {
  ...
  return (
    <div className="w-full bg-white py-16 px-4 mt-1">
          ...
          return (
            <div className="flex flex-col justify-center">
              ...
              <div className="mx-auto">
                <p className="">
                  Part low-top sneaker, part mule - 100% essential. These
                  versatile Chucks are designed for easy, goes-with-everything
                  style. A slightly stretchy crush-back heel allows you to
                  switch up your style between classic low top and backless mule
                  looks. Made with an about 50% recycled cotton canvas upper and
                  everyday neutrals, they're a must-have for warm-weather
                  styling.Women's low-top sneaker with 12oz cotton canvas upper
                  (about 50% recycled cotton, about 50% cotton)Slightly stretchy
                  heel for easy on and offStandard woven tongue label and
                  license plate
                </p>
                <div className="grid  ">
